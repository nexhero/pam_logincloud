...
/*
  Check the user on the owncloud, the logincloud script will print a char to indicate if the user and password re correct or there 
  was a problem.
 */
...
// Check if the user already exists in the local system.
